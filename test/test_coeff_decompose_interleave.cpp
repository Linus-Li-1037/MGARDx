...
template <class T>
void test(string filename, const vector<size_t>& dims, int direction, int target_level){
...
int main(int argc, char ** argv){
    ...
    switch(type){
        case 0:
            {
                test<float>(filename, dims, direction, target_level);
                break;
            }
        case 1:
            {
                test<double>(filename, dims, direction, target_level);
                break;
            }
        default:
